<?php
// billing.php
// --- Iniciar sesión antes de leer $_SESSION ---
...
/**
 * Carga datos del usuario (incluye account_state para decidir redirección)
 */
$stmt = $pdo->prepare("
  SELECT id, full_name, username, currency_pref, plan,
...
// --- Redirección por estado de cuenta ---
$state = strtolower(trim($user['account_state'] ?? ''));
...
/**
 * Planes (Premium = starter) y features
 */
$PLANS = [
  'starter' => [
    'name' => 'Premium',
  ...
  'free' => [
    ...
    'badge' => 'Post-trial',
    'features' => [
      'Todas las funciones de manera ilimitada por 15 días.',
